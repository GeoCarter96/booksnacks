...
<div className='auth__title'>Login To BookSnacks</div>
...
<form onSubmit={doLogin} className='auth__main--form'>
    <input className='auth__main--input' type='email' placeholder='Email Address' onChange={(e) => setEmail(e.target.value)}/>
    <input className='auth__main--input' type='password' placeholder='Password' onChange={(e) => setPassword(e.target.value)}/>
...
<div className='auth_close--btn' onClick={onClose} >
