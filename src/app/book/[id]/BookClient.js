...
export default function BookClient({product}) {

return (
<div>
<div className="row">
<audio src={product.audioLink}></audio>
<div className="container">
<div className="inner__wrapper">
<div className="inner__book">
<div className="inner-book__title">{product.title}</div>
<div className="inner-book__author">{product.author}</div>
<div className="inner-book__sub--title">{product.subTitle}</div>
...
<div className="inner-book__overall--rating">{product.averageRating}</div>
<div className="inner-book__total--rating">{product.totalRating}</div>
...
<div className="inner-book__type">{product.type}</div>
</div>
...
<div className="inner-book__tag">{product.tags}</div>

</div>
<div className="inner-book__book--description">{product.bookDescription}</div>
<h2 className="inner-book__secondary--title">About the author</h2>
<div className="inner-book__author--description">{product.authorDescription}</div>
</div>
<div className="inner-book--img-wrapper">
<figure className="book__image--wrapper" >
<img className="book__image" src={product.imageLink} alt="book" />
</figure>
</div>
</div>
</div>
