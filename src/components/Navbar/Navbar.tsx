...
<input className='search__input' placeholder='Search For Books' type='text' value={search} onChange={(e) => setSearch(e.target.value)}   onBlur={() => setTimeout(() => setResults([]), 200)}></input>
